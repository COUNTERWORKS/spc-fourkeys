...
# REPOS = ["barbara", "corgi", "snuffy", "melanie"]
    ...
    for pr in pull_requests:
        ...
        if since <= created_at <= until:
            row = {
                ...
                "metadata": json.dumps(pr.raw_data),
                "time_created": pr.updated_at.isoformat(),
